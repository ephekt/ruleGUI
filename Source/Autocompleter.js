 ...
 * @copyright	Author
 *
 * Scott Michelson @ Delphi
 * Added choiceFunction
 * removed multiple option
 * Changed tokens to objects such that they store data.
 */
...
*/
	...
	if (this.selectMode) this.setSelection(choice);
    },

    choiceSelect: function(choice) {
	if (choice) this.choiceOver(choice);
	this.setSelection(choice, true);
